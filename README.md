...
<p>
  ...
  <a href="https://www.linkedin.com/in/md-tanvir-uddin-alif-a849a8367"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/></a>
...
Backend developer with a strong foundation in Python and web frameworks, focused on building scalable APIs, robust server-side systems, and AI-integrated applications. Currently pursuing a **B.Sc. in Computer Science & Engineering** at IUBAT — CGPA **3.81**.

I work at the intersection of backend engineering and AI — designing clean architectures, integrating LLMs, and deploying production-ready services.

```python
class Alif:
    role       = "Backend Developer"
    focus      = ["Scalable APIs", "AI Integration", "Clean Architecture"]
    frameworks = ["Django", "Flask", "FastAPI"]
    databases  = ["PostgreSQL", "MySQL"]
    currently  = "Exploring async Python, Docker & LLM orchestration"
    open_to    = "Backend roles · Freelance · Open-source collaboration"
```
...
| Area | Details |
|------|---------|
| 🔐 **Auth & Security** | JWT, OAuth2, API rate limiting |
| ⚡ **Async Python** | FastAPI async patterns, background tasks |
...
<div align="center">
  <i>✨ Open to backend roles, freelance projects, and open-source collaboration.</i>
</div>
